...
using Feast.JsonComment.Generators;
...
namespace Feast.JsonComment.Filters
{
    internal class JsonAttributeFilter : SyntaxFilter<JsonAttributeFilter>, ISyntaxReceiver
    {
        ...
        private string AttributeName { get; } = nameof(JsonCommentAttribute).WithoutAttribute();
        private string AttributeNamespace { get; } = typeof(JsonCommentAttribute).Namespace;
